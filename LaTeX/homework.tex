...
\newcommand{\hmwkClass}{AENG 507X Applied Formal Methods}
\newcommand{\hmwkClassTime}{}
\newcommand{\hmwkClassInstructor}{Professor Rozier}
\newcommand{\hmwkAuthorName}{\small{\textbf{Zahra Hosseini}}}
  
  %
  % This is my new command, it try to create a command for n^2. 
  %
\newcommand*{\nsq}{\ensuremath{n^{2}}}
%
% Title Page
